...
ADMINS = (("OJ", "onlinejuez@gmail.com"),)

# The sender for the aforementioned emails.
SERVER_EMAIL = os.environ.get(
    "SERVER_EMAIL", "Online Judge <onlinejuez@gmail.com>"
)
